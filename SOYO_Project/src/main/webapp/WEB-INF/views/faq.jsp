...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/@materializecss/materialize@2.0.3-alpha/dist/css/materialize.min.css" rel="stylesheet">
    ...
    <style>
        ...
        .collapsible {
            border-radius: 16px;
            overflow: hidden;
            box-shadow: 0 2px 12px rgba(191, 194, 230, 0.10);
            background: #f5f6fd;
        }
        .collapsible-header {
        ...
        .collapsible-header:hover i, .collapsible-header.active i {
            color: #8d90ae;
        }
        .collapsible-body {
            background: #fff;
...
<body>
    ...
    <div class="faq-container">
        ...
        <ul class="collapsible popout">
            <li>
                <div class="collapsible-header"><i class="material-icons">help_outline</i>Q. 배송은 얼마나 걸리나요?</div>
                <div class="collapsible-body">A. 결제 완료 후 평균 2~3일 이내에 발송되며,<br>지역에 따라 1~2일 추가 소요될 수 있습니다. (주말/공휴일 제외)</div>
            </li>
            <li>
                <div class="collapsible-header"><i class="material-icons">help_outline</i>Q. 배송지 정보를 변경하고 싶어요.</div>
                <div class="collapsible-body">A. 상품 발송 전이라면 마이페이지 또는 문의를 통해 배송지 변경이 가능합니다.<br>이미 발송된 경우에는 변경이 어려울 수 있습니다.</div>
            </li>
            <li>
                <div class="collapsible-header"><i class="material-icons">help_outline</i>Q. 교환/반품은 어떻게 하나요?</div>
                <div class="collapsible-body">A. 상품 수령 후 7일 이내에 고객센터 또는 1:1 문의를 통해 신청해주시면<br>안내해드립니다. 단, 착용 흔적이 있거나 택 제거 시 교환/반품이 불가합니다.</div>
            </li>
            <li>
                <div class="collapsible-header"><i class="material-icons">help_outline</i>Q. 세탁은 어떻게 해야 하나요?</div>
                <div class="collapsible-body">A. 한복 재질 특성상 드라이클리닝을 권장합니다.<br>가정에서 세탁 시 찬물에 중성세제로 단독 손세탁해 주세요.</div>
            </li>
            <li>
                <div class="collapsible-header"><i class="material-icons">help_outline</i>Q. 품절 상품은 재입고 되나요?</div>
                <div class="collapsible-body">A. 품절된 상품은 재입고 알림 신청이 가능합니다.<br>상품 상세 페이지에서 <b>'재입고 알림'</b> 버튼을 이용해 주세요.</div>
            </li>
            <li>
                <div class="collapsible-header"><i class="material-icons">help_outline</i>Q. 결제 수단에는 어떤 것이 있나요?</div>
                <div class="collapsible-body">A. 신용카드, 체크카드, 실시간 계좌이체, 무통장입금,<br>간편결제(카카오페이, 네이버페이 등) 등 다양한 결제 수단을 지원합니다.</div>
            </li>
            <li>
                <div class="collapsible-header"><i class="material-icons">help_outline</i>Q. 사이즈가 맞지 않으면 어떻게 하나요?</div>
                <div class="collapsible-body">A. 사이즈가 맞지 않을 경우, 동일 상품 내에서 1회 무료 교환이 가능합니다.<br>교환 신청은 상품 수령 후 7일 이내에 해주세요.</div>
            </li>
            <li>
                <div class="collapsible-header"><i class="material-icons">help_outline</i>Q. 주문 내역은 어디서 확인할 수 있나요?</div>
