...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>소요 SOYO</h1>
            <p>고요한 아름다움,<br>일상 속 전통의 여백<br><br>미완성 페이지!<br>(더 다듬을 예정)</p>
    ...
    <section class="section" id="philosophy">
        <div class="container">
            ...
            <div class="section-content">
                <div class="card">
                    <h3>전통과 현대의 공존</h3>
                    <p>소요는 전통 한복의 우아함을 현대적인 실루엣으로 재해석합니다. 
                    과거와 현재를 잇는 다리 역할을 하며, 일상 속에서도 자연스럽게 
                    전통의 아름다움을 경험할 수 있도록 합니다.</p>
                </div>
                <div class="card">
                    <h3>일상 속 아름다움</h3>
                    <p>특별한 날이 아닌, 평범한 일상 속에서도 한복의 아름다움을 
                    느낄 수 있도록 합니다. 현대인의 라이프스타일에 맞춘 
                    실용적이면서도 세련된 디자인을 추구합니다.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section" id="sensibility">
        <div class="container">
            ...
            <div class="section-content">
                <div class="card">
                    <h3>차분한 미니멀리즘</h3>
                    <p>불필요한 장식을 제거하고 본질적인 아름다움에 집중합니다. 
                    절제된 디자인으로 더욱 깊이 있는 미감을 전달합니다.</p>
                </div>
                <div class="card">
                    <h3>고급스러운 색감</h3>
                    <p>전통적인 색채를 현대적으로 재해석하여 차분하면서도 
                    세련된 컬러 팔레트를 구사합니다.</p>
                </div>
            </div>
        </div>
    ...
    <section class="section" id="message">
        <div class="container">
            ...
            <div class="section-content">
                <div class="card">
                    <h3>자유로운 표현</h3>
                    <p>소요(逍遙)라는 이름처럼, 전통의 틀에 구애받지 않고 
                    자유롭게 표현하고자 합니다. 현대적 감각으로 재해석된 
                    한복을 통해 새로운 문화를 만들어갑니다.</p>
                </div>
                <div class="card">
                    <h3>지속가능한 가치</h3>
                    <p>단순한 트렌드가 아닌, 지속가능한 가치를 추구합니다. 
                    전통의 가치를 지키면서도 현대적 감각을 더해 
                    새로운 문화유산을 만들어갑니다.</p>
                </div>
            </div>
        </div>
